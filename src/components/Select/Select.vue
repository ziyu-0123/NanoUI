<template>
  ...
  >
    ...
    <template #content>
      <div class="nano-select__loading" v-if="states.loading"><Icon icon="spinner" spin/></div>
      <div class="nano-select__nodata" v-else-if="filterable && filteredOptions.length === 0">no matching data</div>
      <ul class="nano-select__menu" v-else>
        <template v-for="(item, index) in filteredOptions" :key="index">
          <li 
            class="nano-select__menu-item"
            :class="{
