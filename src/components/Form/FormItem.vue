<template>
  <div 
    ...
    <label class="nano-form-item__label">
      <slot name="label" :label="label">
        {{ label }}
      </slot>
    </label>
    <div class="nano-form-item__content">
      <slot :validate="validate"/>
      <div class="nano-form-item__error-msg" v-if="validateStatus.state === 'error'">
