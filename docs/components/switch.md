...
绑定 v-model 到一个 Boolean 类型的变量。 可以使用 **--nano-switch-on-color** 属性与 **--nano-switch-off-color** 属性来设置开关的背景色。
...
<preview path="../demo/Switch/Disabled.vue" title="基础Switch" description="Switch 基础用例"></preview>
